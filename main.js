...
addMemberButton.addEventListener('click', function() {
    ...
    paragraph.addEventListener('click', function() {
        ...
        memberAttributes.innerHTML = generateEmployeeForm(memberNames);
    });
    memberAttributes.innerHTML = generateEmployeeForm(memberNames);
});
...
submitButton.addEventListener('click', function() {
    ...
    basicTableLable.innerHTML = "Basic Table";
    ...
    basicTableRoundedLable.innerHTML = "Basic Table Rounded";
